//REST client: hosts marked dead for the first time should not be immediately retried.
...
public class RestClient implements Closeable {
   ...
   /**
    ...
    static class FailureTrackingResponseListener {
        ...
        /**
         * Tracks one last definitive failure and returns to the caller by notifying the wrapp
         */
